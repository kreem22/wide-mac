...
- **Leave creative space**: Be specific about the algorithmic direction, but concise enough that the next Assistant has room to make interpretive implementation choices at an extremely high level of craftsmanship.
...
- **ARTISTIC FREEDOM**: The next Assistant interprets the philosophy algorithmically - provide creative implementation room
...
To allow exploration of the generative art, create a single, self-contained HTML artifact. Ensure this artifact works immediately in the artifacts viewer or any browser - no setup required. Embed everything inline.
...
1. **In the artifacts viewer**: Displayed as an interactive artifact - runs instantly
